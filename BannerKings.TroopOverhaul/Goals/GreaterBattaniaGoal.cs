...
{
    internal class GreaterBattaniaGoal : EmpireGoal
    {
        ...
        public override string TitleId => "goal_greater_battania";

        public GreaterBattaniaGoal() : base("goal_greater_battania", GoalCategory.Unique, GoalUpdateType.Settlement)
        {
            var name = new TextObject("{=!}Unite Pendreiciaeth y Battaniaid");
        ...
        public override void ApplyGoal()
        {
            ...
            TitleGenerator.FoundEmpire(foundAction, new TextObject("{=!}Pendreiciaeth y Battaniaid"), 
                TitleId);
        }
